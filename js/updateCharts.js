...
function drawLineGraph() {
  ...
  let boxWidth = parseInt(svg.style("width").substring(0, svg.style("width").length-2))
  let boxHeight = svg.style("height").substring(0, svg.style("height").length-2)
